...
describe('$q', function() {
  ...
  it('rejects when nested promise rejects in finally', function(done) {
    var d = $q.defer();
    var fulflledSpy = jasmine.createSpy();
    var rejectedSpy = jasmine.createSpy();
    var rejectNested;
    ...
    d.promise.then(function(result) {
      ...
      return d2.promise;
    }).then(fulflledSpy, function(reason) {
      rejectedSpy(reason)
      expect(rejectedSpy).toHaveBeenCalledWith('fail');
    });
    d.resolve(20);
    ...
    function next() {
      ...
      setTimeout(function() {
        setTimeout(function() {
          expect(fulflledSpy).not.toHaveBeenCalled();
          // expect(rejectedSpy).tsoHaveBeenCalledWith('fail');
          done()
        })
      })
    }
  ...
  it('can make an immediately rejected promise', function(done) {
    var fulfilledSpy = jasmine.createSpy();
    var rejectedSpy = jasmine.createSpy();
  ...
  it('can make an immediately resolved promise', function(done) {
    var fulfilledSpy = jasmine.createSpy();
    var rejectedSpy = jasmine.createSpy();
  ...
  it('can wrap a foreign promise', function(done) {
    var fulfilledSpy = jasmine.createSpy();
    var rejectedSpy = jasmine.createSpy();
    var promise = $q.when({
  ...
  it('takes callbacks directly when wrapping', function(done) {
    var fulfilledSpy = jasmine.createSpy();
    var rejectedSpy = jasmine.createSpy();
    var progressSpy = jasmine.createSpy();
    var wrapped = $q.defer();
  ...
  it('makes an immediately resolved promise with resolve', function(done) {
    var fulfilledSpy = jasmine.createSpy();
    var rejectedSpy = jasmine.createSpy();
  ...
  describe('all', function() {
    ...
    it('can resolve an array of promises to array of results', function(done) {
    ...
    it('can resolve an object of promises to an object of results', function(done) {
      var promise = $q.all({
        a: $q.when(1),
        b: $q.when(2)
      });
    ...
    it('resolves an empty array of promises immediately', function(done) {
      var promise = $q.all([]);
      var fulfilledSpy = jasmine.createSpy();
    ...
    it('resolves an empty object of promises immediately', function(done) {
      var promise = $q.all({});
      var fulfilledSpy = jasmine.createSpy();
      promise.then(fulfilledSpy);
    ...
    it('rejects when any of the promises rejects', function(done) {
      var promise = $q.all([$q.when(1), $q.when(2), $q.reject('fail')]);
      var fulfilledSpy = jasmine.createSpy();
      var rejectedSpy = jasmine.createSpy();
      promise.then(fulfilledSpy, function(reason){
        rejectedSpy(reason)
        expect(rejectedSpy).toHaveBeenCalledWith('fail');
        done()
      });
    ...
    it('wraps non-promises in the input collection', function(done) {
  ...
  describe('ES2015 style', function() {
    ...
    it('returns a promise', function() {
      ...
      expect($q(function() {}).then).toBeDefined();
    });

    it('calls function with a resolve function', function(done) {
      var fulflledSpy = jasmine.createSpy();
      $q(function(resolve) {
        resolve('ok');
      }).then(function(value) {
    ...
    it('calls function with a reject function', function(done) {
      var fulflledSpy = jasmine.createSpy();
      var rejectedSpy = jasmine.createSpy();
